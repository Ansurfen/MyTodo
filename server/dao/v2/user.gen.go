...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.IsMale = field.NewBool(tableName, "is_male")
	_user.Email = field.NewString(tableName, "email")
	_user.Telephone = field.NewField(tableName, "telephone")
...
func (u *user) updateTableName(table string) *user {
	...
	u.IsMale = field.NewBool(table, "is_male")
	u.Email = field.NewString(table, "email")
	u.Telephone = field.NewField(table, "telephone")
...
type IUserDo interface {
	...
	FilterWithNameAndRole(name string, role string) (result []po.User, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (u userDo) FilterWithNameAndRole(name string, role string) (result []po.User, err error) {
