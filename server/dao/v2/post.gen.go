...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.UID = field.NewUint(tableName, "uid")
	_post.Content = field.NewString(tableName, "content")
	_post.Image = field.NewField(tableName, "image")
...
func (p *post) updateTableName(table string) *post {
	...
	p.Image = field.NewField(table, "image")
...
type IPostDo interface {
	...
	Unscoped() IPostDo
	Create(values ...*po.Post) error
	CreateInBatches(values []*po.Post, batchSize int) error
	Save(values ...*po.Post) error
	First() (*po.Post, error)
	Take() (*po.Post, error)
	Last() (*po.Post, error)
	Find() ([]*po.Post, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.Post, err error)
	FindInBatches(result *[]*po.Post, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po.Post) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po.Post, error)
	FirstOrCreate() (*po.Post, error)
	FindByPage(offset int, limit int) (result []*po.Post, count int64, err error)
	...
	FilterWithNameAndRole(name string, role string) (result []po.Post, err error)
}

// SELECT * FROM @@table WHERE name = @name{{if role !=""}} AND role = @role{{end}}
func (p postDo) FilterWithNameAndRole(name string, role string) (result []po.Post, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, name)
	generateSQL.WriteString("SELECT * FROM post WHERE name = ? ")
	if role != "" {
...
func (p postDo) Create(values ...*po.Post) error {
	if len(values) == 0 {
		return nil
	}
...
func (p postDo) CreateInBatches(values []*po.Post, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p postDo) Save(values ...*po.Post) error {
	if len(values) == 0 {
		return nil
	}
...
func (p postDo) First() (*po.Post, error) {
	if result, err := p.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po.Post), nil
	}
}

func (p postDo) Take() (*po.Post, error) {
...
func (p postDo) Last() (*po.Post, error) {
...
func (p postDo) Find() ([]*po.Post, error) {
	result, err := p.DO.Find()
	return result.([]*po.Post), err
}

func (p postDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.Post, err error) {
	buf := make([]*po.Post, 0, batchSize)
...
func (p postDo) FindInBatches(result *[]*po.Post, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p postDo) FirstOrInit() (*po.Post, error) {
...
func (p postDo) FirstOrCreate() (*po.Post, error) {
...
func (p postDo) FindByPage(offset int, limit int) (result []*po.Post, count int64, err error) {
...
func (p postDo) Delete(models ...*po.Post) (result gen.ResultInfo, err error) {
