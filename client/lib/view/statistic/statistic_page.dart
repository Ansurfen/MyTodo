...
import 'package:my_todo/view/statistic/4h_task_analysis.dart';
import 'package:my_todo/view/statistic/pie_chart.dart';
          ...
          BarChartData(
            ...
            gridData: FlGridData(
              ...
              getDrawingHorizontalLine: (value) {
                if (value == 0) {
                  return FlLine(
                    color: ChartColor.borderColor.withOpacity(0.1),
                    strokeWidth: 3,
                  );
                }
                return FlLine(
                  color: ChartColor.borderColor.withOpacity(0.05),
                  strokeWidth: 0.8,
                );
              },
            ),
                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: ChartHolder(
                        chartSample: LineChartSample(
                            1, (context) => const LineChartSample1()),
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(40.0),
                    ...
                    Padding(
                      ...
                      child: ChartHolder(
                        chartSample: LineChartSample(
                            3, (context) => const BarChartSample5()),
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(40.0),
